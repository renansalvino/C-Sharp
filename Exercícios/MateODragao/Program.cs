            ...
            do {
                ...
                switch (opcaoBatalhaJogador) {
                    case "1":
                        ...
                        System.Console.WriteLine ($"{guerreiro.Nome.ToUpper()}: {dragao.Nome}, Seu vagabundo Xerador! Vim -lhe derrotar-lhe, seu baderneiro!!!!");
                        System.Console.WriteLine ($"{dragao.Nome.ToUpper()}: Humano tolinho.");
